...
int main() {
  ...
  cout << "The output will consist of the file name, page number, and a value."
       << endl;
  ...
  cout << "Expected Result: Error statments followed by the \"Test passed\" "
          "statement."
       << endl;
  ...
  cout << "flushing file with pages still pinned. Should generate an error"
       << endl;
