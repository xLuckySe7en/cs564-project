...
HeapFile::~HeapFile() {
  ...
  if (curPage != NULL) {
    // cout <<  "unpinning page " << curPageNo << "with dirtyFlag " <<
    // curDirtyFlag << endl;
  ...
  // unpin the header page
  // cout <<  "unpinning headerPage  " << headerPageNo << "with dirtyFlag " <<
  // hdrDirtyFlag << endl;
...
InsertFileScan::~InsertFileScan() {
  ...
  if (curPage != NULL) {
    // cout << "executing insertfilescan destructor. unpinning page " <<
    // curPageNo << endl;
...
const Status InsertFileScan::insertRecord(const Record &rec, RID &outRid) {
  ...
  if (status == OK) {
    ...
    if (status != OK)
      return status;
    // cout << "insertRecord.  page was full. got new page " << newPageNo <<
    // endl;
