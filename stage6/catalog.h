...
public:
  ...
  const Status createRel(const string &relation, const int attrCnt,
...
public:
  ...
  const Status getInfo(const string &relation, const string &attrName,
                       AttrDesc &record);
  ...
  const Status getRelInfo(const string &relation, int &attrCnt,
                          AttrDesc *&attrs);
